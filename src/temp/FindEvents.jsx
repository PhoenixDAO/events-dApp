...
class FindEvents extends Component {
	...
	async filterHideEvents() {
		try {
			...
			console.log("hey view error", error);
		}
	}
			...
			<React.Fragment>
				<Carousel className="retract-page-inner-wrapper">
					<Carousel.Item className="slide1">
						...
						<Carousel.Caption>
							...
							<button
								...
								onClick={() => {
									this.caruselClick("/topic/music/1");
								}}
							>
								<i className="fas fa-ticket-alt"></i> Find
								Events
							</button>
						</Carousel.Caption>
					</Carousel.Item>
					<Carousel.Item className="slide2">
						<img
							className="d-block slider w-100 "
							src="/images/topics/charity-and-causes.jpg"
							alt="First slide"
						/>
						<Carousel.Caption>
					...
					<Carousel.Item className="slide3">
						...
						<Carousel.Caption>
							...
							<button
								className="btn btn-dark"
								onClick={() => {
									this.caruselClick("/topic/parties/1");
								}}
							>
								<i className="fas fa-ticket-alt"></i> Find
								Events
					...
					<Carousel.Item className="slide4">
						<img
							className="d-block w-100 slider"
							src="/images/topics/sports-and-fitness.jpg"
							alt="First slide"
						/>
						<Carousel.Caption>
					...
					<Carousel.Item className="slide5">
						...
						<Carousel.Caption>
							...
							<p>
								Create your own event, it takes only a minute.
							</p>
							<button
								className="btn btn-dark"
								onClick={() => {
									this.caruselClick("/createevent");
								}}
							>
								<i className="fas fa-ticket-alt"></i> Create
								Event
							</button>
						</Carousel.Caption>
					</Carousel.Item>
