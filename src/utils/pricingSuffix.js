...
function formatting(num, type) {
	if (type == "$") {
		if (num > 999 && num < 1000000) {
			return (
				type +
				Math.round((num / 1000 + Number.EPSILON) * 10000) / 10000 +
				"K"
			);
		} else if (num > 999999 && num < 1000000000) {
			return (
				type +
				Math.round((num / 1000000 + Number.EPSILON) * 10000) / 10000 +
				"M"
			);
		} else if (num > 999999999 && num < 1000000000000) {
			return (
				type +
				Math.round((num / 1000000000 + Number.EPSILON) * 10000) /
					10000 +
				"B"
			);
			...
			return (
				type +
				Math.round((num / 1000000000000 + Number.EPSILON) * 10000) /
					10000 +
				"T"
			);
		} else if (num < 999) {
			...
			return (
				type +
				Math.round((num / 1000000000000000 + Number.EPSILON) * 10000) /
					10000 +
				"P"
			);
		} else {
