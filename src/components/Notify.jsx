	...
	if (error) {
		return (
			<div className="notify2">
				<div><i class="fas fa-exclamation-circle fa-3x" style={{ color: "#F43C3C" }}></i></div>
				<div>Transaction {error && error.code == 4001 ? "Rejected" : "failed"}😥. Try again later.</div>
			</div>
		)
	}
	else {
