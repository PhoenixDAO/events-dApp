      ...
      <Carousel className="retract-page-inner-wrapper">
          <Carousel.Item className="slide1">
            ...
            <Carousel.Caption>
              ...
              <a href="#search"><button className="btn btn-dark" onClick={() => {this.caruselClick("/topic/music/1")}}><i className="fas fa-ticket-alt"></i> Find Events</button></a>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <img className="d-block w-100" src="/images/topics/charity-and-causes.jpg" alt="First slide" />
            <Carousel.Caption>
              ...
              <a href="#search"><button className="btn btn-dark" onClick={() => {this.caruselClick("/topic/charity-and-causes/1")}}><i className="fas fa-ticket-alt"></i> Find Events</button></a>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <img className="d-block w-100" src="/images/topics/parties.jpg" alt="First slide" />
            <Carousel.Caption>
              ...
              <a href="#search"><button className="btn btn-dark" onClick={() => {this.caruselClick("/topic/parties/1")}}><i className="fas fa-ticket-alt"></i> Find Events</button></a>
            </Carousel.Caption>
          </Carousel.Item>
          ...
          <img className="d-block w-100" src="/images/topics/sports-and-fitness.jpg" alt="First slide" />
            <Carousel.Caption>
              ...
              <p>Praesent commodo cursus magna, vel scelerisque nisl consectetur.</p>
              <a href="#search"><button className="btn btn-dark" onClick={() => {this.caruselClick("/topic/sports-and-fitness/1")}}><i className="fas fa-ticket-alt"></i> Find Events</button></a>
            </Carousel.Caption>
          </Carousel.Item>
